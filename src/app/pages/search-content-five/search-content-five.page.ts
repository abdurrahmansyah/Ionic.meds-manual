...
@Component({
  selector: 'app-search-content-five',
  templateUrl: './search-content-five.page.html',
  styleUrls: ['./search-content-five.page.scss'],
})
export class SearchContentFivePage implements OnInit {
  datas: ContentData[] = [];
  param: any;
  ...
  // content
  thisRoute: string = dataTemp.route.searchContentFive;
