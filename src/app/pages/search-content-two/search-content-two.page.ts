...
@Component({
  selector: 'app-search-content-two',
  templateUrl: './search-content-two.page.html',
  styleUrls: ['./search-content-two.page.scss'],
})
export class SearchContentTwoPage implements OnInit {
  datas: ContentData[] = [];
  param: any;
  ...
  // content
  thisRoute: string = dataTemp.route.searchContentTwo;
