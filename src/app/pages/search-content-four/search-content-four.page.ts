...
@Component({
  selector: 'app-search-content-four',
  templateUrl: './search-content-four.page.html',
  styleUrls: ['./search-content-four.page.scss'],
})
export class SearchContentFourPage implements OnInit {
  datas: ContentData[] = [];
  param: any;
  ...
  // content
  thisRoute: string = dataTemp.route.searchContentFour;
