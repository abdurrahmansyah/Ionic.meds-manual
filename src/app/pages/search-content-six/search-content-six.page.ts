...
@Component({
  selector: 'app-search-content-six',
  templateUrl: './search-content-six.page.html',
  styleUrls: ['./search-content-six.page.scss'],
})
export class SearchContentSixPage implements OnInit {
  datas: ContentData[] = [];
  param: any;
  ...
  // content
  thisRoute: string = dataTemp.route.searchContentSix;
