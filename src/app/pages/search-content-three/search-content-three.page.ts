...
@Component({
  selector: 'app-search-content-three',
  templateUrl: './search-content-three.page.html',
  styleUrls: ['./search-content-three.page.scss'],
})
export class SearchContentThreePage implements OnInit {
  datas: ContentData[] = [];
  param: any;
  ...
  // content
  thisRoute: string = dataTemp.route.searchContentThree;
